			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> New Entry
						...
						<span class="float:right"><a class="btn btn-info btn-block btn-sm col-sm-2 float-right" href="index.php?page=stored_procedure" id="">
					<i class="fas fa-info"></i> Branch Info
				</a></span>
					</div>
					<div class="card-body">
