	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<span class="float:left"><a class="btn btn-danger btn-block btn-sm col-sm-2 float-right" href="index.php?page=log" id="new_student">
				<i class="fas fa-user-minus"></i> Deleted Student
				</a></span>
					</div>
					<div class="card-body">
